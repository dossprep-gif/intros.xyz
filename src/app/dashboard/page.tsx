            ...
            <div className="p-12 flex items-start justify-between">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="relative">
                  <div className="w-60 h-60 rounded-2xl flex items-center justify-center text-6xl font-bold shadow-lg overflow-hidden" style={{ 
                      ...
                      <div className="flex flex-wrap gap-3 justify-center">
                        {Object.entries(user.socialLinks).map(([platform, url]) => (
                          <a
                            ...
                            className="flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 hover:scale-110 hover:shadow-lg"
                            style={{ 
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3 mb-6">
                    {user.position && (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-base" style={{ color: '#374151' }}>{user.position}</span>
                      </div>
                    )}
                    ...
                    {user.location && (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-base" style={{ color: '#374151' }}>Homebase: {user.location}</span>
                      </div>
                    )}
                    ...
                    {user.education && (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-base" style={{ color: '#374151' }}>{user.education}</span>
                      </div>
                    )}
                    ...
                    {user.expertise && user.expertise.length > 0 && (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-base" style={{ color: '#374151' }}>Expertise: {user.expertise.join(', ')}</span>
                      </div>
                    )}
                    ...
                    {user.hobbies && user.hobbies.length > 0 && (
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-base" style={{ color: '#374151' }}>Interests: {user.hobbies.join(', ')}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <Link
                      ...
                      className="px-6 py-3 rounded-xl font-semibold transition-all duration-200 hover:scale-105 border-2"
                      style={{ 
                        backgroundColor: '#FFFFFF',
                        color: '#1A2B7A',
                        borderColor: '#1A2B7A'
